...
namespace Ahorcado.ECCI {
    ...
    public interface ECCI_HolaMundoPort {
        ...
        // CODEGEN: Generating message contract since the wrapper name (iniciarJuegoReturn) of message iniciarJuegoResponse does not match the default value (iniciarJuego)
        ...
        // CODEGEN: Generating message contract since the wrapper name (ingresarLetraReturn) of message ingresarLetraResponse does not match the default value (ingresarLetra)
        ...
        // CODEGEN: Generating message contract since the wrapper name (obtenerIntentosRestantesReturn) of message obtenerIntentosRestantesResponse does not match the default value (obtenerIntentosRestantes)
        ...
        // CODEGEN: Generating message contract since the wrapper name (obtenerPalabraParcialReturn) of message obtenerPalabraParcialResponse does not match the default value (obtenerPalabraParcial)
        ...
        // CODEGEN: Generating message contract since the wrapper name (obtenerPalabraReturn) of message obtenerPalabraResponse does not match the default value (obtenerPalabra)
        ...
        // CODEGEN: Generating message contract since the wrapper name (obtenerTiempoReturn) of message obtenerTiempoResponse does not match the default value (obtenerTiempo)
